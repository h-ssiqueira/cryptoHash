...
@Slf4j
@NoArgsConstructor
public class GOST3411_2012_512StrategyImpl implements CryptoHashStrategy {

    private final GOST3411_2012_512Digest gost3411_2012_512 = new GOST3411_2012_512Digest();
    ...
    public EncryptionResponseDTO encrypt(String password) {
        ...
        var end = Instant.now();
        log.info(LOG001, "encrypt", "GOST3411_2012_512", Duration.between(start, end).toMillis());
    ...
    public PasswordMatchingResponseDTO matches(PasswordMatchingRequestDTO passwordMatchingRequestDTO) {
        ...
        var end = Instant.now();
        log.info(LOG001, "match", "GOST3411_2012_512", Duration.between(start, end).toMillis());
        return new PasswordMatchingResponseDTO(match);
    }

    private String encrypt(byte[] text) {
        gost3411_2012_512.update(text,0,text.length);
        var encrypted = new byte[gost3411_2012_512.getDigestSize()];
        gost3411_2012_512.doFinal(encrypted,0);
